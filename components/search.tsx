...
import { CmdIcon } from "@/components/ui/icons";
    ...
    return (
        <CommandMenu.Dialog open={open} onOpenChange={setOpen}>
            ...
            <CommandMenu.DialogDescription className="sr-only">
                This command menu allows you to quickly access features and
                navigate through different sections by typing relevant commands.
